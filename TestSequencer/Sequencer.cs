...
namespace TestSequencer {
    ...
    [XmlRoot(nameof(TO))] public class TO : IAssertion {
        ...
        public String Assertion() {
            ...
            if (TestGroups.Count > 0) sb.Append($"{CONTINUE}{nameof(TestGroups)}{CS}{TGs()}");
            sb.Append($"{END}");
            return sb.ToString();
        }
    ...
    public class TG : IAssertion {
        ...
        public String Assertion() {
            ...
            if (Methods.Count > 0) sb.Append($"{TO.CONTINUE}{nameof(Methods)}{TO.CS}{Ms()}");
            sb.Append($"{TO.END}");
            return sb.ToString();
        }
        private String Ms() {
    ...
    public class MC : MethodShared, IAssertion {
        ...
        public String Assertion() {
            ...
            if (Parameters.Count > 0) sb.Append($"{nameof(Parameters)}{TO.CS}{Ps()}{TO.END}");
            return sb.ToString();
        }
        private String Ps() {
            StringBuilder sb = new StringBuilder();

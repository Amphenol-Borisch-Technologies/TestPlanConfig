...
namespace T10 {
    ...
    internal class Class1 {
        ...
        static string Method1() {
			...
			Debug.Assert(Next(Method: "Method2"));
			return String.Empty;
        }
        
        static string Method2() {
			Debug.Assert(Prior(Method: "Method1"));
			...
			Debug.Assert(Next(Method: "Method3"));
			return String.Empty;
        }
        
        static string Method3() {
			Debug.Assert(Prior(Method: "Method2"));
			...
			Debug.Assert(Next(Method: "Method4"));
			return String.Empty;
        }
        
        static string Method4() {
			Debug.Assert(Prior(Method: "Method3"));
    ...
    internal class Class2 {
        ...
        static string Method5() {
			...
			Debug.Assert(Next(Method: "Method6"));
			return String.Empty;
        }
        
        static string Method6() {
			Debug.Assert(Prior(Method: "Method5"));
			...
			Debug.Assert(Next(Method: "Method7"));
			return String.Empty;
        }
        
        static string Method7() {
			Debug.Assert(Prior(Method: "Method6"));
			...
			Debug.Assert(Next(Method: "Method8"));
			return String.Empty;
        }
        
        static string Method8() {
			Debug.Assert(Prior(Method: "Method7"));

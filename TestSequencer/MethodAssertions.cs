...
namespace TestSequencer {
    internal static class Assertions {
        ...
        internal static Boolean TG_Prior(String TG) { return true; }
        internal static Boolean TG_Next(String TG) { return true; }
        ...
        internal static Boolean MS_Prior(String Method) { return true; }
        internal static Boolean MS_Next(String Method) { return true; }
    }
}
